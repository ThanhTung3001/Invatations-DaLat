...
export default function CardTimer(cardTimer: INumberCardTimer) {
  ...
  return (
    <div className="p-8 bg-white text-primary rounded-md hover:cursor-pointer md:text-4xl sm:text-2xl text-xl lg:text-8xl min-w-[150px] hover:bg-primary hover:text-white">
      {numberShow}
